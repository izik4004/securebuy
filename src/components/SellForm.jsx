...
const SellForm = ({modalOpen, setModalOpen}) => {
  return (
    ...
    class="py-12 bg-gray-100 transition duration-50 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0" id="modal">
    <div role="alert" class=" mx-auto w-8/12 md:w-2/3 max-w-md">
        <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded-xl">
